            ...
            <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
                ...
                <form onSubmit={onSubmithandler}>
                    <div className='mb-3 min-w-72'>
                        ...
                        <input onChange={(e) => setEmail(e.target.value)} value={email} className='rounded w-full px-3 py-2 border border-gray-300 outline-none' type='email' placeholder='Enter your email' required />
                    </div>
                    <div>
                    ...
                    <button className='mt-2 w-full px-4 py-2 font-semibold rounded-md bg-red-500 text-black hover:text-white' type='submit'>Login</button>
